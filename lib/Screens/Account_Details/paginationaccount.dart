...
class PaginationdetailsScreen extends StatefulWidget {
  @override
  _PaginationdetailsScreenState createState() => _PaginationdetailsScreenState();
}

class _PaginationdetailsScreenState extends State<PaginationdetailsScreen> {
